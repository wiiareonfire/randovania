...
JOKE_HINTS = [
    ...
    "*Have you ever thought about Zeta Metroid Jockeys? Well, now you have.*",
    "*Judging by the architecture on SR-388, the Chozo's favourite transportation device seem to be TUUUUUUUUUBES!*",
    "*Only a FOOL would expect me to give you useful hints.*",
    "*Space Jump, Ice, Bombs? You want it? It's yours, my friend, as long as you have enough credits.*",
    "*S P E E N*",
    "*Wisdom... is everything.*",
    "*You are faced with an overwhelming amount of cute Septogg noises. Accept your helplessness.*",
    "*Sorry, I do not have much to say. Thanks for talking to me though.*",
